...
describe('TaskList', () => {
  it('shows loading state', () => {
    render(
      <TaskList tasks={[]} loading={true} error={null} onToggle={vi.fn()} onDelete={vi.fn()} onEdit={vi.fn()} />
    );
  ...
  it('shows error state', () => {
    render(
      <TaskList tasks={[]} loading={false} error="Network Error" onToggle={vi.fn()} onDelete={vi.fn()} onEdit={vi.fn()} />
    );
  ...
  it('renders list of tasks', () => {
    render(
      <TaskList tasks={mockTasks} loading={false} error={null} onToggle={vi.fn()} onDelete={vi.fn()} onEdit={vi.fn()} />
    );
  ...
  it('calls onToggle when checkbox clicked', () => {
    ...
    render(
      <TaskList tasks={mockTasks} loading={false} error={null} onToggle={onToggle} onDelete={vi.fn()} onEdit={vi.fn()} />
    );
